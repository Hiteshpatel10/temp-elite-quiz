...
class _RandomBattleScreenState extends State<RandomBattleScreen> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      ...
      if (context.read<SystemConfigCubit>().isCategoryEnabledForBattle) {
        _getCategories();
      }
    });
  }
  ...
  void _getCategories() {
    context.read<QuizCategoryCubit>().getQuizCategoryWithUserId(
          ...
          subType: UiUtils.subTypeFromQuizType(QuizTypes.battle),
  ...
  Widget selectCategoryDropDown() {
    return context.read<SystemConfigCubit>().isCategoryEnabledForBattle
    ...
    return CustomRoundedButton(
      ...
      onTap: () {
        ...
        if (selectedCategory == selectCategoryKey &&
            context.read<SystemConfigCubit>().isCategoryEnabledForBattle) {
          UiUtils.errorMessageDialog(
            context,
